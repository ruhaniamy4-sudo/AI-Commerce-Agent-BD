...
export default function AIUsagePage() {
    ...
    const cards: Array<[string, string | number, React.ElementType]> = data ? [
        ['AI requests', data.requests, BrainCircuit], ['Input tokens', data.inputTokens, TextCursorInput],
        ['Output tokens', data.outputTokens, TextCursorInputIcon], ['Estimated cost', data.estimatedCost === null ? 'Unavailable' : `$${data.estimatedCost.toFixed(4)}`, Coins],
    ] : [];
