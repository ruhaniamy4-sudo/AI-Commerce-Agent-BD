  ...
  if (error) {
    return (
      <div className="flex flex-col h-full min-h-[80vh] items-center justify-center p-8">
        ...
        <h2 className="text-3xl font-black text-foreground tracking-tighter mb-2">Nexus Connectivity Error</h2>
        ...
        <Button variant="outline" onClick={() => window.location.reload()} className="mt-8 rounded-2xl bg-muted/40 border-border text-foreground font-bold h-14 px-12 hover:bg-muted/60">Re-Establish Link</Button>
      </div>
    )
  }
  ...
  return (
    <div className="flex flex-col h-full min-h-[90vh]">
      <PageHeader
        ...
        actions={
          <div className="flex items-center gap-3 px-4 py-2 bg-muted/40 border border-border rounded-2xl backdrop-blur-md">
            <div className={cn(
      ...
      <div className="py-8">
        <div className="grid gap-8 md:grid-cols-3">
          <Card className="glass-card border-border shadow-premium rounded-3xl overflow-hidden bg-muted/20">
            <CardHeader className="p-8 pb-4">
              ...
              <CardTitle className="text-xl font-black text-foreground tracking-tight text-primary">Core Vitality</CardTitle>
          ...
          <Card className="glass-card border-border shadow-premium rounded-3xl overflow-hidden bg-muted/20">
            <CardHeader className="p-8 pb-4">
              ...
              <CardTitle className="text-xl font-black text-foreground tracking-tight">Automation Logic</CardTitle>
              ...
              <div className="flex flex-col gap-6">
                <div className="p-6 bg-muted/30 rounded-3xl border border-border space-y-4">
                  <p className="text-sm text-muted-foreground font-medium leading-relaxed">
                    Agent initializes autonomously after <span className="text-foreground font-black underline decoration-primary underline-offset-4">{status?.autoStartRule?.inactivityMinutes || 5} cycles</span> of operator dormancy.
                  </p>
          ...
          <Card className="glass-card border-border shadow-premium rounded-3xl overflow-hidden bg-muted/20">
            <CardHeader className="p-8 pb-4">
              ...
              <CardTitle className="text-xl font-black text-foreground tracking-tight">Defense Clusters</CardTitle>
              <CardDescription className="text-muted-foreground/60 font-medium">Safety and compliance layers</CardDescription>
            </CardHeader>
            <CardContent className="p-8 pt-0">
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 bg-muted/30 rounded-2xl border border-border flex flex-col items-center justify-center text-center">
                  ...
                  <span className="text-[10px] font-black text-foreground mt-1 uppercase tracking-widest">Uplink.256</span>
                </div>
                <div className="p-4 bg-muted/30 rounded-2xl border border-border flex flex-col items-center justify-center text-center">
                  ...
                  <span className="text-[10px] font-black text-foreground mt-1 uppercase tracking-widest text-primary">Neural.V8</span>
                </div>
              </div>
            </CardContent>
          </Card>

          <Card className="md:col-span-3 glass-card border-border shadow-premium rounded-3xl overflow-hidden bg-muted/20 border-t-4 border-t-primary/20">
            <CardHeader className="p-8 border-b border-border bg-muted/20">
              <CardTitle className="text-2xl font-black text-foreground tracking-tighter uppercase tracking-widest">Operator Console</CardTitle>
              ...
              <div className="flex flex-col md:flex-row items-center justify-center gap-12">
                <div className="flex flex-col items-center gap-6">
                  ...
                  <div className="flex flex-col items-center gap-1">
                    <span className="text-[10px] font-black uppercase tracking-[0.3em] text-foreground">Initialize Agent</span>
                    <span className="text-[8px] font-medium text-muted-foreground">Status: {isActive ? "Running" : "Ready"}</span>
                  </div>
                </div>

                <div className="h-px w-24 md:h-24 md:w-px bg-muted/50" />
                ...
                <div className="flex flex-col items-center gap-6">
                  ...
                  <div className="flex flex-col items-center gap-1">
                    <span className="text-[10px] font-black uppercase tracking-[0.3em] text-foreground">Deactivate Agent</span>
