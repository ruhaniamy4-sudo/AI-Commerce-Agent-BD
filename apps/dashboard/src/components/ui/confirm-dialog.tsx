            ...
            <DialogPrimitive.Root open={Boolean(request)} onOpenChange={(open) => !open && answer(false)}>
                <DialogPrimitive.Portal>
                    ...
                    <DialogPrimitive.Content
                        ...
                        className="fixed left-1/2 top-1/2 z-[101] w-[calc(100vw-2rem)] max-w-md -translate-x-1/2 -translate-y-1/2 rounded-2xl border border-border bg-card p-6 shadow-[var(--sp-shadow-floating)] duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95"
                    >
                                ...
                                {request?.reason && (
                                    <label className="mt-4 block text-xs font-medium text-muted-foreground">
                                        ...
                                        <textarea
                                            ...
                                            className="mt-2 w-full resize-none rounded-lg border border-border bg-background px-3 py-2 text-sm font-normal text-foreground outline-none focus:border-primary"
                                        />
                                    </label>
                                )}
                            </div>
