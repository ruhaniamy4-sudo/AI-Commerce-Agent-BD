...
export function HomeSalesAgent({ showcaseOnly = false }: { showcaseOnly?: boolean } = {}) {
  ...
  const sceneContent = (
    <div className={`sales-scene-wrap ${showcaseOnly ? "sales-scene-centered" : ""}`}>
      <p className="sr-only">
  ...
  if (showcaseOnly) {
    return (
      <div
        className="sales-showcase-wrapper"
