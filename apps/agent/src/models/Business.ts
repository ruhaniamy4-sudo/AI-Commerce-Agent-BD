...
import {
  BUSINESS_TYPES,
  BusinessType,
} from "../services/adaptive-training.service";
...
const BusinessSchema = new Schema<IBusiness>(
  {
    ...
    businessTypeStatus: {
      type: String,
      enum: ["unconfirmed", "inferred", "confirmed"],
      default: "unconfirmed",
      index: true,
    },
    businessTypeInference: {
      value: { type: String, enum: BUSINESS_TYPES },
    ...
    commerce: {
      ...
      deliveryFees: {
        insideDhaka: { type: Number, min: 0, max: 10000, default: 80 },
        outsideDhaka: { type: Number, min: 0, max: 10000, default: 130 },
      },
      deliveryPolicy: { type: String, trim: true, maxlength: 500 },
      returnPolicy: { type: String, trim: true, maxlength: 500 },
      salesChannel: { type: String, trim: true, maxlength: 160 },
    },
    storefront: {
      primaryColor: {
        type: String,
      ...
      heroSubtitle: { type: String, trim: true, maxlength: 240 },
      layout: { type: String, enum: ["grid", "editorial"], default: "grid" },
    },
    aiAccess: {
      status: {
        type: String,
    ...
    brandVoice: {
      tone: {
        type: String,
        enum: ["friendly", "professional", "casual", "premium", "custom"],
        default: "friendly",
      },
      replyLength: {
        type: String,
      ...
      language: {
        type: String,
        enum: ["auto", "bn", "en", "banglish"],
        default: "auto",
      },
      salesBehavior: {
        type: String,
        enum: ["helpful", "balanced", "sales_focused"],
        default: "balanced",
      },
      emoji: {
        type: String,
        enum: ["none", "light", "normal"],
        default: "light",
      },
    ...
    training: {
      ...
      importPreference: {
        type: String,
        enum: ["in_stock_only", "all", "ask_during_review"],
        default: "ask_during_review",
      },
    },
    trialImport: {
      importedAt: Date,
      messagesUsed: { type: Number, min: 0, max: 10 },
      history: [
        {
